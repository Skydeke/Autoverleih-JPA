...
public class ErrorMsgs {
    ...
    public static final String DBCON_ACC_FAILED = "Datenbank-Verbindung konnte nicht aufgebaut werden.";
    public static final String DBCON_CRE_FAILED = "Die Datenbank-Verbindung konnte nicht geöffnet werden.";
    public static final String DBCON_CRE_SUC = "Verbindung zu Datenbank hergestellt.";
